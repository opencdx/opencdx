...
class OpenCDXMedicationAdministrationModelTest {
    @Test
    void getProtobufMessage() {
        ...
        OpenCDXMedicationAdministrationModel model = new OpenCDXMedicationAdministrationModel(medicationAdministration);
        Assertions.assertNotEquals(medicationAdministration, model.getProtobufMessage());
    }
}
