...
public class OpenCDXMedicalHistoryGrpcController extends MedicalHistoryServiceGrpc.MedicalHistoryServiceImplBase {
     ...
     */
    @Override
    public void createMedicalHistory(CreateMedicalHistoryRequest request, StreamObserver<CreateMedicalHistoryResponse> responseObserver) {
     ...
     */
    @Override
    public void updateMedicalHistory(UpdateMedicalHistoryRequest request, StreamObserver<UpdateMedicalHistoryResponse> responseObserver) {
     ...
     */
    @Override
    public void deleteMedicalHistory(DeleteMedicalHistoryRequest request, StreamObserver<SuccessResponse> responseObserver) {
     ...
     */
    @Override
    public void listMedicalHistories(ListMedicalHistoriesRequest request, StreamObserver<ListMedicalHistoriesResponse> responseObserver) {
