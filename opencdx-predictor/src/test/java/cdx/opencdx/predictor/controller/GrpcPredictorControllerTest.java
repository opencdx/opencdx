...
import cdx.opencdx.predictor.model.Person;
import cdx.opencdx.predictor.repository.PersonRepository;
import cdx.opencdx.predictor.service.impl.PredictorServiceImpl;
...
class GrpcPredictorControllerTest {
    ...
    PredictorServiceImpl predictorService;

    GrpcPredictorController grpcPredictorController;
    ...
    void setUp() {
        ...
        this.predictorService = new PredictorServiceImpl(this.openCDXAuditService, openCDXCurrentUser);
        this.grpcPredictorController = new GrpcPredictorController(this.predictorService);
    }
