...
/**
 * Implementation of the MedicalHistory gRPC Client.
 */
@Slf4j
@Observed(name = "opencdx")
public class OpenCDXMedicalHistoryClientImpl implements OpenCDXMedicalHistoryClient {
    private static final String OPEN_CDX_MEDICAL_HISTORY_CLIENT_IMPL = "OpenCDXMedicalHistoryClientImpl";
    private final MedicalHistoryServiceGrpc.MedicalHistoryServiceBlockingStub medicalHistoryServiceBlockingStub;

    /**
     * Constructor for the Vaccine client implementation.
     * @param channel gRPC Blocking Stub for Vaccine.
     */
    public OpenCDXMedicalHistoryClientImpl(ManagedChannel channel) {
        this.medicalHistoryServiceBlockingStub = MedicalHistoryServiceGrpc.newBlockingStub(channel);
    }
    ...
    public CreateMedicalHistoryResponse createMedicalHistory(
        ...
        try {
            return medicalHistoryServiceBlockingStub
                    ...
                    .createMedicalHistory(request);
        } catch (StatusRuntimeException e) {
            com.google.rpc.Status status = io.grpc.protobuf.StatusProto.fromThrowable(e);
            throw new OpenCDXClientException(
                    Code.forNumber(status.getCode()),
                    OPEN_CDX_MEDICAL_HISTORY_CLIENT_IMPL,
                    1,
                    status.getMessage(),
     ...
     */
    @Override
    public ListMedicalHistoriesResponse listMedicalHistories(
            ListMedicalHistoriesRequest request, OpenCDXCallCredentials openCDXCallCredentials) {
        try {
            return medicalHistoryServiceBlockingStub
                    .withCallCredentials(openCDXCallCredentials)
                    .listMedicalHistories(request);
        } catch (StatusRuntimeException e) {
            com.google.rpc.Status status = io.grpc.protobuf.StatusProto.fromThrowable(e);
            throw new OpenCDXClientException(
                    Code.forNumber(status.getCode()),
