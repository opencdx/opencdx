...
public class GrpcCountryController extends CountryServiceGrpc.CountryServiceImplBase {
     ...
     */
    public GrpcCountryController(OpenCDXCountryService openCDXCountryService) {
