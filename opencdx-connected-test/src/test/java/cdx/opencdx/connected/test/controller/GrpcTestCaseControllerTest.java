...
class GrpcTestCaseControllerTest {
    ...
    GrpcTestCaseController grpcTestCaseController;
    ...
    void setUp() {
        ...
        this.grpcTestCaseController = new GrpcTestCaseController(this.openCDXTestCaseService);
    }
    ...
    void getTestCaseById() {
        ...
        TestCaseIdRequest testCaseIdRequest = TestCaseIdRequest.newBuilder()
                ...
                .build();
        this.grpcTestCaseController.getTestCaseById(testCaseIdRequest, responseObserver);
    ...
    void addTestCase() {
        ...
        TestCase testCase = TestCase.newBuilder()
                ...
                .build();
        this.grpcTestCaseController.addTestCase(testCase, responseObserver);
    ...
    void updateTestCase() {
        ...
        TestCase testCase = TestCase.newBuilder()
                ...
                .setVendorId(ObjectId.get().toHexString())
                .build();
        this.grpcTestCaseController.updateTestCase(testCase, responseObserver);
    ...
    void deleteTestCase() {
        ...
        TestCaseIdRequest testCaseIdRequest = TestCaseIdRequest.newBuilder()
                .setTestCaseId(ObjectId.get().toHexString())
                .build();
        this.grpcTestCaseController.deleteTestCase(testCaseIdRequest, responseObserver);
