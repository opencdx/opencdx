...
const CustomTabs = React.forwardRef(({ control, register, index, currentIndex, item }) => {
    ...
    return (
        <Box sx={{ width: '100%' }}>
            ...
            <CustomTabPanel value={value} index={0}>
                <Time {...{ control, register, index, currentIndex, item }} />
            </CustomTabPanel>
            <CustomTabPanel value={value} index={1}>
                <SubjectofRecord {...{ control, register, index, currentIndex, item }} />
            </CustomTabPanel>
            <CustomTabPanel value={value} index={2}>
                <Authors {...{ control, register, index, currentIndex, item }} />
            </CustomTabPanel>
            ...
            <CustomTabPanel value={value} index={6}>
                <CircumstanceChoice {...{ control, register, index, currentIndex, item }} />
            </CustomTabPanel>
        </Box>
    );
});
