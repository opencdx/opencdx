                                        ...
                                        .setDiagnosisCode(DiagnosisCode.newBuilder()
                                                ...
                                                .setAnfStatement(ANFStatement.newBuilder()
                                                        .setTime(Measure.newBuilder()
                                                                ...
                                                                .setIncludeUpperBound(true)
                                                                .setSemantic(LogicalExpression.newBuilder().setExpression("mmHg"))
                                                                .setResolution("1")
                                                                .build())
                                                        .setSubjectOfRecord(Participant.newBuilder()
                                                                ...
                                                                .setCode(LogicalExpression.newBuilder().setExpression("Patient 1"))
                                                                .build())
                                                        .addAllAuthors(List.of(Practitioner.newBuilder()
                                                                ...
                                                                .setCode(LogicalExpression.newBuilder().setExpression("Patient 1"))
                                                                .build()))
                                                        .setSubjectOfInformation(LogicalExpression.newBuilder().setExpression(OpenCDXIdentifier.get()
                                                                .toHexString()))
                                                        .addAllAssociatedStatement(
                                                                List.of(AssociatedStatement.newBuilder()
                                                                        ...
                                                                        .setSemantic(LogicalExpression.newBuilder().setExpression("mmHg"))
                                                                        .build()))
                                                        .setTopic(LogicalExpression.newBuilder().setExpression("Blood Pressure"))
                                                        .setType(LogicalExpression.newBuilder().setExpression("Medical Apppointment"))
                                                        .setNarrativeCircumstance(NarrativeCircumstance.newBuilder()
                                                                .setTiming(Measure.newBuilder()
                                                                        ...
                                                                        .setResolution("1")
                                                                        .build())
                                                                .addAllPurpose(List.of(LogicalExpression.newBuilder().setExpression("Patient Summary").build()))
                                                                .setText(
