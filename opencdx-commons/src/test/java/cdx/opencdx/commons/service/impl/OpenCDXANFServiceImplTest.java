                        ...
                        .addAllAnfStatementConnector(List.of(AnfStatementConnector.newBuilder()
                                .setAnfStatement(ANFStatement.newBuilder()
                                        ...
                                        .addAllAssociatedStatement(List.of(AssociatedStatement.newBuilder()
                                                ...
                                                .build()))
                                        .setTopic(
                                                LogicalExpression.newBuilder().setExpression("255585003 |Malignant neoplasm of liver |finding site|624008003 |Bone structure| "))
                                        ...
                                        .setPerformanceCircumstance(PerformanceCircumstance.newBuilder()
                                                ...
                                                .setHealthRisk(
                                                        LogicalExpression.newBuilder().setExpression("${{rules.engine.calculated[circumstanceChoice.result]}}"))
                        ...
                        .addAllAnfStatementConnector(List.of(AnfStatementConnector.newBuilder()
                                .setAnfStatement(ANFStatement.newBuilder()
                                        ...
                                        .setRequestCircumstance(RequestCircumstance.newBuilder()
                                                .addRequestedParticipant(Participant.newBuilder()
                                                        .setId("UUID (PatientId)")
                                                        .setCode(LogicalExpression.newBuilder().setExpression("UUID (EncounterID)"))
                                                        .build())
                                                .addAllPurpose(List.of(LogicalExpression.newBuilder().setExpression("purpose").build()))
                                                .addConditionalTrigger(AssociatedStatement.newBuilder()
                                                        .build())
                                                .setPriority(LogicalExpression.newBuilder().setExpression("high"))
                        ...
                        .addAllAnfStatementConnector(List.of(AnfStatementConnector.newBuilder()
                                .setAnfStatement(ANFStatement.newBuilder()
                                        ...
                                        .setNarrativeCircumstance(NarrativeCircumstance.newBuilder()
                                                .addPurpose(LogicalExpression.newBuilder().setExpression("purpose"))
                                                .setText("text")
                        ...
                        .addAllAnfStatementConnector(List.of(AnfStatementConnector.newBuilder()
                                .setAnfStatement(ANFStatement.newBuilder()
                                        ...
                                        .setPerformanceCircumstance(PerformanceCircumstance.newBuilder()
                                                .addAllPurpose(List.of(LogicalExpression.newBuilder().setExpression("purpose").build()))
                                                .setStatus(
                                                        LogicalExpression.newBuilder().setExpression("{\"expressionType\":\"simple\",\"expressionLanguage\":\"local\",\"expressionValue\":\"performed\",\"expressionDescription\":\"Measurement action has been performed.\"}").build())
                                                .setHealthRisk(
                                                        LogicalExpression.newBuilder().setExpression("${{rules.engine.calculated[circumstanceChoice.result]}}"))
                                                .setResult(Measure.newBuilder()
                                                        .setLowerBound("90")
