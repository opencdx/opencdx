...
/**
 * OpenCDXAuditProcessingRequest occurs when current operation cannot be processsed.
 *  <p>
 *  Https Status: PRECONDITION_FAILED
 *  <p>
 *  Google Code: FAILED_PRECONDITION
 **/
public class OpenCDXAuditProcessingRequest extends OpenCDXException {
    /**
     ...
     */
    protected OpenCDXAuditProcessingRequest(HttpStatus status, Code code, String domain, int number, String message) {
     ...
     */
    protected OpenCDXAuditProcessingRequest(HttpStatus status, Code code, String domain, int number, String message, Throwable cause) {
     ...
     */
    protected OpenCDXAuditProcessingRequest(HttpStatus status, Code code, String domain, int number, String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
     ...
     * @param writableStackTrace Boolean to indicate writeable stack trace.
     */
    public OpenCDXAuditProcessingRequest(
            String domain,
            int number,
            String message,
            Throwable cause,
